...
#     src = "assets",
#     script = "popover.js",
#     stylesheet =  c(file = "popover2.css"),
...
# 
#   # class definition
#   class_tooltip <- paste0("popover global-tooltip bg-",if (tooltip_color == "default"){"black"} else {tooltip_color})
#   
...
#   }
#   
#   class_inner <- paste0("tooltip-inner bg-",if (tooltip_color == "default"){"black"} else {tooltip_color})
#   
#   # template definition
